...
@section('css_script')
	...
	<script>
      ...
      <!-- //font-awesome icons -->
      <!--Slider -->
      <link href="{{ asset('frontEnd') }}/css/lsb.css" rel="stylesheet" type="text/css">
      <!-- //slider-->
      <!--stylesheets-->
            ...
            <ul id="flexiselDemo1">
               <li>
                  <div class="agileinfo_port_grid">
                     <a href="{{ asset('frontEnd') }}/images/s1.jpg" class="lsb-preview" data-lsb-group="header">
                        <div class="agileit-folio_grid">
                           <img src="{{ asset('frontEnd') }}/images/s1.jpg" alt=" " class="img-fluid" />
                        </div>
                     </a>
                  </div>
               </li>
               <li>
                  <div class="agileinfo_port_grid mt-lg-4 mt-3">
                     <a href="{{ asset('frontEnd') }}/images/s2.jpg" class="lsb-preview" data-lsb-group="header">
                        <div class="agileit-folio_grid">
                           <img src="{{ asset('frontEnd') }}/images/s2.jpg" alt=" " class="img-fluid" />
                        </div>
                     </a>
                  </div>
               </li>
               <li>
                  <div class="agileinfo_port_grid">
                     <a href="{{ asset('frontEnd') }}/images/s3.jpg" class="lsb-preview" data-lsb-group="header">
                        <div class="agileit-folio_grid">
                           <img src="{{ asset('frontEnd') }}/images/s3.jpg" alt=" " class="img-fluid" />
                        </div>
                     </a>
                  </div>
               </li>
               <li>
                  <div class="agileinfo_port_grid mt-lg-4 mt-3">
                     <a href="{{ asset('frontEnd') }}/images/s4.jpg" class="lsb-preview" data-lsb-group="header">
                        <div class="agileit-folio_grid">
                           <img src="{{ asset('frontEnd') }}/images/s4.jpg" alt=" " class="img-fluid" />
                        </div>
                     </a>
                  </div>
               </li>
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            ...
            <div class="row service-both">
               <div class="col-lg-5 wthree-left-img-ser">
                  <img src="{{ asset('frontEnd') }}/images/ser1.jpg" class="img-thumbnail" alt="">
               </div>
